...
export type CheckUserSession = Action<USER_ACTION_TYPES.CHECK_USER_SESION>;
...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData, aadditionalDetails: AdditionalInformation }>;
...
export const setCurrentUser = withMatcher((user: UserData) => createAction(USER_ACTION_TYPES.SET_CURRENT_USER, user));

export const checkUserSession = withMatcher((): CheckUserSession => createAction(USER_ACTION_TYPES.CHECK_USER_SESION));
...
export const signUpSuccess = withMatcher((user: UserData, aadditionalDetails: AdditionalInformation): SignUpSuccess =>
    createAction(USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user, aadditionalDetails }));
